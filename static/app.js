const translations = {
  zh: {
    ...
    apiDocs: "开发者 API", workspaceTitle: "智能订正", workspaceSubtitle: "检索教材依据，再验证每一步",
    welcomeEyebrow: "从错误步骤开始", welcomeTitle: "把错题弄懂，不只算出答案",
    welcomeCopy: "输入完整题目和你的错误作答。系统会检索教材、定位第一处错误，并在输出前独立校验。",
  ...
  en: {
    ...
    apiDocs: "Developer API", workspaceTitle: "Guided correction", workspaceSubtitle: "Retrieve evidence, then verify each step",
    welcomeEyebrow: "Start from the mistake", welcomeTitle: "Understand the mistake, not just the answer",
    welcomeCopy: "Enter the full problem and your incorrect attempt. The system retrieves textbook evidence, finds the first error, and validates the response independently.",
