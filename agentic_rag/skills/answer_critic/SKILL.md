---
name: answer_critic
description: Use this repository Skill for answer critic in the junior-mathematics tutoring pipeline. It applies whenever this capability is executed by Workflow, Tool-Calling, MCP, or evaluation.
---

# math.answer_critic

Validate input against `AnswerCriticInput`, execute only the declared answer critic capability, and return `CriticOutput`.
