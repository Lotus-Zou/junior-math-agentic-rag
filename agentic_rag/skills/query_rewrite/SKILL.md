---
name: query_rewrite
description: Use this repository Skill for query rewrite in the junior-mathematics tutoring pipeline. It applies whenever this capability is executed by Workflow, Tool-Calling, MCP, or evaluation.
---

# math.query_rewrite

Validate input against `QueryRewriteInput`, execute only the declared query rewrite capability, and return `QueryRewriteOutput`.
