...
description: Use this repository Skill for retrieve graph in the junior-mathematics tutoring pipeline. It applies whenever this capability is executed by Workflow, Tool-Calling, MCP, or evaluation.
---

# math.retrieve_graph

Validate input against `RetrievalInput`, execute only the declared retrieve graph capability, and return `RetrievalOutput`.
