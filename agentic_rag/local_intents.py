...
_COMMANDS = {
    ...
    "practice": LocalCommand("practice"),
    ...
    "太简单了": LocalCommand("adjust_difficulty", difficulty_delta=1),
    "太容易了": LocalCommand("adjust_difficulty", difficulty_delta=1),
    "这个太简单了": LocalCommand("adjust_difficulty", difficulty_delta=1),
    "harder": LocalCommand("adjust_difficulty", difficulty_delta=1),
    "too easy": LocalCommand("adjust_difficulty", difficulty_delta=1),
    "too simple": LocalCommand("adjust_difficulty", difficulty_delta=1),
    "\u7b80\u5355\u4e00\u70b9": LocalCommand("adjust_difficulty", difficulty_delta=-1),
    "太难了": LocalCommand("adjust_difficulty", difficulty_delta=-1),
    "这个太难了": LocalCommand("adjust_difficulty", difficulty_delta=-1),
    "easier": LocalCommand("adjust_difficulty", difficulty_delta=-1),
    "too hard": LocalCommand("adjust_difficulty", difficulty_delta=-1),
